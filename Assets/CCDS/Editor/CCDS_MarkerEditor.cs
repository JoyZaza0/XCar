...
public class CCDS_MarkerEditor : Editor {
    ...
    public void CCDS_FinderListener(int id) {
        ...
        ACCDS_Mission[] missions = FindObjectsOfType<ACCDS_Mission>(true);
        ...
        CCDS_MissionObjectivePosition[] spawnPoints = FindObjectsOfType<CCDS_MissionObjectivePosition>(true);
