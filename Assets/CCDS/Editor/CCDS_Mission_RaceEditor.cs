...
public class CCDS_Mission_RaceEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (prop.waypointPath == null) {
            ...
            RCCP_AIWaypointsContainer[] waypointPaths = FindObjectsOfType<RCCP_AIWaypointsContainer>(true);
            ...
            if (GUILayout.Button("Create New Waypoint Path")) {
                ...
                EditorApplication.delayCall += () => {
                    ...
                    RCCP_AIWaypointsContainer[] containers = FindObjectsOfType<RCCP_AIWaypointsContainer>();
