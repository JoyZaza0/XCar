...
public class RCCP_CreateNewVehicle {
    ...
    public static RCCP_CarController NewVehicle(GameObject vehicle) {
        ...
        int answer2 = EditorUtility.DisplayDialogComplex("Adding CCDS_Player", "Is this vehicle will be a player vehicle? Player cars have ''CCDS_Player'' component attached to them. AI vehicles don't have this component. If this vehicle will be an AI vehicle, choose ''No''.", "Yes", "No", "");

        if (answer2 == 0)
            Selection.activeGameObject.AddComponent<CCDS_Player>();
