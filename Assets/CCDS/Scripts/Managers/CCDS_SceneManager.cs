...
public class CCDS_SceneManager : CCDS_Singleton<CCDS_SceneManager>, ICCDS_CheckEditorError {
    ...
    public CCDS_GameplayManager GameplayManager {
        ...
        get {
            ...
            if (gameplayManager == null)
                gameplayManager = FindObjectOfType<CCDS_GameplayManager>();
    ...
    public CCDS_UI_Manager CCDSUIManager {
        ...
        get {
            ...
            if (gameplayUIManager == null)
                gameplayUIManager = FindObjectOfType<CCDS_UI_Manager>();
    ...
    public CCDS_MarkerManager MarkerManager {
        ...
        get {
            ...
            if (markerManager == null)
                markerManager = FindObjectOfType<CCDS_MarkerManager>();
    ...
    public CCDS_MissionObjectiveManager MissionManager {
        ...
        get {
            ...
            if (missionManager == null)
                missionManager = FindObjectOfType<CCDS_MissionObjectiveManager>();
    ...
    public CCDS_MissionObjectivePositionsManager MissionPositions {
        ...
        get {
            ...
            if (missionPositions == null)
                missionPositions = FindObjectOfType<CCDS_MissionObjectivePositionsManager>();
    ...
    public CCDS_MinimapManager MinimapManager {
        ...
        get {
            ...
            if (minimapManager == null)
                minimapManager = FindObjectOfType<CCDS_MinimapManager>();
    ...
    public CCDS_CopsManager CopsManager {
        ...
        get {
            ...
            if (copsManager == null)
                copsManager = FindObjectOfType<CCDS_CopsManager>();
    ...
    public CCDS_MainMenuManager MainMenuManager {
        ...
        get {
            ...
            if (mainmenuManager == null)
                mainmenuManager = FindObjectOfType<CCDS_MainMenuManager>();
    ...
    public CCDS_UI_MainMenuManager MainMenuUIManager {
        ...
        get {
            ...
            if (mainmenuUIManager == null)
                mainmenuUIManager = FindObjectOfType<CCDS_UI_MainMenuManager>();
    ...
    public CCDS_Camera_Orbit CameraOrbit {
        ...
        get {
            ...
            if (orbitCamera == null)
                orbitCamera = FindObjectOfType<CCDS_Camera_Orbit>();
    ...
    public CCDS_SoundtrackManager SoundtrackManager {
        ...
        get {
            ...
            if (soundtrackManager == null)
                soundtrackManager = FindObjectOfType<CCDS_SoundtrackManager>();
    ...
    public RCCP_SceneManager RCCPSceneManager {
        ...
        get {
            ...
            if (rccpSceneManager == null)
                rccpSceneManager = FindObjectOfType<RCCP_SceneManager>();
    ...
    public RCCP_Camera RCCPCamera {
        ...
        get {
            ...
            if (rccpCamera == null)
                rccpCamera = FindObjectOfType<RCCP_Camera>();
    ...
    public string[] CheckMisconfigurations() {
        ...
        AudioListener[] audioListeners = FindObjectsOfType<AudioListener>(false);
