        ...
        get {
            ...
            if (arrowIndicator == null) {
                ...
                if (CCDS_Settings.Instance.arrowForPlayer != null) {
                    ...
                    arrowIndicator = Instantiate(CCDS_Settings.Instance.arrowForPlayer.gameObject, GetComponentInChildren<Camera>().transform).GetComponent<CCDS_ArrowIndicator>();
                    arrowIndicator.root = GetComponentInChildren<Camera>().transform;
