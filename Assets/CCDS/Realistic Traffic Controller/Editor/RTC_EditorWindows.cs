...
public class RTC_EditorWindows : EditorWindow {
    ...
    [MenuItem("Tools/BoneCracker Games/Realistic Traffic Controller/URP/Convert All Demo Materials To URP", false, 500)]
    [MenuItem("GameObject/BoneCracker Games/Realistic Traffic Controller/URP/Convert All Demo Materials To URP", false, 500)]
    public static void URP() {
        ...
        for (int i = 0; i < objects.Length; i++) {
            ...
            if (RTC_DemoMaterials.Instance.demoMaterials[i] != null)
